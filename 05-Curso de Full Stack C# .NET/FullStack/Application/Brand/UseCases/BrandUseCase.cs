...
namespace Application.Brand.UseCases
{
    public class BrandUseCase : IUseCase<BrandEntity>
    {
        ...
        public async Task AddAsync(BrandEntity entity) => await _repository.AddAsync(entity);
        ...
        public async Task UpdateAsync(BrandEntity entity) => await _repository.UpdateAsync(entity);
    }
}
